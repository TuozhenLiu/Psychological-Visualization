...
data <- read_sav("./data/data_clean_fresh_combined_8075.sav")

vari_list <- c("gender_d1", "age", "ethnic_d", "citytype", "economic", "socialclass", "QQ59", "Mpesac", "Mpesat", "Msil")
vari_list_full <- c("Gender", "Age", "Ethnic group", "Residence", "Economic status", "Social class", "Media preference", "PES activity", "PES attitude", "SIL")
...
data %>%
  ...
  write.csv("Significance level.csv", na = "")

data2 <- read.csv("Significance level.csv")
data2 %>%
